...
btn1.addEventListener("click", function(){
    ...
    // 비동기  - 동기는 위에서부터 쭉 해석이 되는데 비동기는 한번에 다 해석이 된데.
    ...
    window.setTimeout(function(){
        // window.setTimeout()에서 this == window 내장 객체
        // console.log(this);
        btn1.style.backgroundColor="orange";
    }, 3000);
    
    console.log("중간에 출력"); // 이게 클릭 하자마자 나옴. 동시에 해석됨.
...
openPopup3.addEventListener("click", function(){
    ...
    // window.open("09_배열.html", "popupWindow", 옵션)
...
document.getElementById("sendChild").addEventListener("click", function(){
    ...
    // 팝업창 내에서 툴바, 작업표시줄 이런것들이 없어져서 완전한 정사각형이 안나오는거래.
