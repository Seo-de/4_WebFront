...
document.getElementById("btn2").addEventListener("click", function(){
    ...
    // 1, 10, 2, 3, 5 => 문자열 기준 정렬이라서 10이 2번째로 나옴

    console.log(numArr.sort(function(a,b){return a-b;}));
    // -> 숫자 기준 정렬 : 1, 2, 3, 5, 10
    // function(a,b){return a-b;}) => a-b를 해서 양수가 나오면 
    // 들어간 숫자 두개가 자리를 바꾸면서 정렬이 되는거래


    // * sort() 함수는 원본 배열의 순서를 정렬함
    // -> 원본 훼손이 발생(깊은 복사를 이용해 해결 가능)
    console.log(numArr);
